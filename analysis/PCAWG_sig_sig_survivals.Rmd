...
ggsave(plot = mult_tissues_ROS_SBS40_adjusted + theme(plot.margin = unit(c(0, 1.5, 0,0), units = "cm") ),
       filename = file.path(fig.dir, "mult_tissues_SBS40_ROS.survivals.pdf"),
       width = 4, height = 3.5)
...
ggsave(plot = mult_tissues_ROS_SBS40_ggforest,
       filename = file.path(fig.dir, "mult_tissues_SBS40_ROS.ggforest.pdf"),
       width = 6, height = 2.9)
...
ggsave(plot = eso_APOBEC_HR$survP$plot + theme(plot.margin = unit(c(4,4,4,4), units = "mm")) + 
       ...
       filename = file.path(fig.dir, "Eso_APOBEC_HR.survivals.pdf"),
       width = 4, height = 3.5)
...
ggsave(plot = APOBEC_HR_eso_ggforest,
       filename = file.path(fig.dir, "Eso_APOBEC_HR.ggforest.pdf"),
       width = 6, height = 2.2)
