...
pos.picked.models = get_surv_best_model(positive.sig.sig, 
                                 ...
                                 tmb.logged = TRUE,
                                 binary.status = FALSE)
saveRDS(pos.picked.models, file = file.path(out.dir, "pcawg.pos.picked.models.RDS"))
```
...
neg.picked.models = get_surv_best_model(negative.sig.sig, 
                                 ...
                                 tmb.logged = TRUE,
                                 binary.status = FALSE)
saveRDS(neg.picked.models, file = file.path(out.dir, "pcawg.neg.picked.models.RDS"))
```
