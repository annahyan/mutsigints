...
```{r}
tcga.colon.immune.states = pathways_signatures_heatmap(tissue = "ColoRect_AdenoCa", signatures = tcga.immune.sigs, pathways = tcga.immune.tissues, border_color = NA)
...
```{r}
tcga.uterine.immune.states = pathways_signatures_heatmap(tissue = "Uterus_AdenoCa", signatures = tcga.immune.sigs, pathways = tcga.immune.tissues, border_color = NA)
