...
for (tissue in names(tissue.odds.ratios.null)) {
    ...
    quantiles.mat = do.call(rbind, 
                            lapply(tissue.odds.ratios.null[[tissue]], function(x) {
                                if(length(x) == 0) {
...
tissue.odds.ratio.null.adjusted = setNames(
    lapply(names(tissue.odds.ratio.unadjusted),
           function(tissue) {
               ...
               nm = tissue.odds.ratios.null[[tissue]]
...
```{r}
pp.odds.ratio.unadjusted = plot_all_counts(tissue.odds.ratio.null.adjusted, threshold = 0.2, psize = 5)
