...
```{r}
pp.odds.ratio.unadjusted = plot_all_counts(tissue.odds.ratio.unadjusted, threshold = 0.2, psize = 5)
...
```{r, warning = FALSE}
tissue.lm.coefs.mats.log = TCGA_sig_pathway_int(sigs.input = TCGA.full.subset.ann.pathways,
                                 pathways.input = TCGA.pathways.tissues,
...
```{r}
tissue.log.coefs.mats.log = TCGA_sig_pathway_int(sigs.input = TCGA.full.subset.ann.pathways,
                                 pathways.input = TCGA.pathways.tissues,
                                 interaction_function = get_sig_path_lms, 
                                 path.min.tissues = 30,
                                 p.val.threshold = 0.1,
