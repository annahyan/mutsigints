...
for (tissue in names(PCAWG.tissue.counts) ) {
    ...
    cat(tissue, "\n")
    PCAWG.tissue.null.quantiles.95[[tissue]] = get_tissue_null_quantiles(tissue, PCAWG.full.subset.ann, metric_functions)
...
for (tissue in names(TCGA.tissue.counts) ) {
    ...
    cat(tissue, "\n")
    TCGA.tissue.null.quantiles.95[[tissue]] = get_tissue_null_quantiles(tissue, TCGA.full.subset.ann, metric_functions)
