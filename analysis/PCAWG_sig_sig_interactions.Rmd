...
sig.sig.ints.summary.plot = plot_all_counts(PCAWG.networks.concat, min.abssum = 3,
                                            psize = 4.5, lsize = 1.7, 
...
sig.sig.ints.summary.plot = plot_all_counts(PCAWG.networks.concat, min.abssum = 5,
                                            psize = 6, lsize = 2, 
                                            expand.mult = c(0.02, 0.02)) + 
