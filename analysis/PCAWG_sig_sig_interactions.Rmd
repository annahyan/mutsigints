...
sig.sig.ints.summary.plot = plot_all_counts(networks.concat, min.abssum = 5,
                                            psize = 6, lsize = 2, 
                                            expand.mult = c(0.02, 0.02)) + 
...
PCAWG.int.tissues = get_interaction_tissues(networks.concat)

write_tsv(as.data.frame(PCAWG.int.tissues$pos.tissues), 
          file = here("supp_data", "PCAWG_positive_interaction_tissue_summaries.tsv"))
write_tsv(as.data.frame(PCAWG.int.tissues$neg.tissues), 
