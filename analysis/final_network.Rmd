...
ggsave(plot = minor_plot(pcawg.sig.sig.all.network$pp, expand.factor = 0.2),
...
circular.node.order = circular.node.order[ circular.node.order %in% network.nodes]
...
ggsave(plot = minor_plot(tcga.sig.sig.all.network$pp, expand.factor = 0.2),
