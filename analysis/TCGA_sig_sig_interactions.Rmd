...
TCGA.int.tissues = get_interaction_tissues(networks.concat)

write_tsv(as.data.frame(TCGA.int.tissues$pos.tissues), 
          file = here("supp_data", "TCGA_positive_interaction_tissue_summaries.tsv"))
write_tsv(as.data.frame(TCGA.int.tissues$neg.tissues), 
