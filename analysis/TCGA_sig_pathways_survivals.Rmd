...
saveRDS(pos.picked.models, file = file.path(out.dir, "tcga.pos.sig.path.picked.models.RDS"))
```
...
saveRDS(neg.picked.models, file = file.path(out.dir, "tcga.neg.sig.path.picked.models.RDS"))
```
